...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		KCmap = new UnfoldingMap(this, 450, 50, 350, 500, provider);
		
		KCmap.zoomAndPanTo(zoomLevel, new Location(-22.9, -43.2));
		
		MapUtils.createDefaultEventDispatcher(this,KCmap);
	...
	public void draw() {
		...
		// TODO: Add code so that both maps are displayed properly
		map1.draw();
		KCmap.draw();
	}
